...
impl BlockListKerberos {
    ...
    async fn request_type(&self) -> &str {
    ...
    async fn error_msg(&self) -> &str {
        &self.inner.error_msg
    }

    async fn from(&self) -> i64 {
        self.inner.from
    }

    async fn till(&self) -> i64 {
        self.inner.till
    }

    async fn cipher(&self) -> &str {
        &self.inner.cipher
    }

    async fn forwardable(&self) -> &str {
        &self.inner.forwardable
    }

    async fn renewable(&self) -> &str {
        &self.inner.renewable
    }

    async fn client_cert_subject(&self) -> &str {
        &self.inner.client_cert_subject
    }

    async fn server_cert_subject(&self) -> &str {
        &self.inner.server_cert_subject
    }
